    ...
    sections: [
      ...
      },
      {
        ...
        body: `
            ...
            <p>Sorumlu taraf, yapıtın yayımlanıp yayımlanmayacağı, iletilip iletilmeyeceği, dağıtılıp dağıtılmayacağı, sunulup sunulmayacağı veya başka bir biçimde ortaya konulup konulmayacağı konusundaki yetkiyi elinde tutmuştur.</p>
            <h4>5.5 Benimseme</h4>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Tesadüfi veya tümüyle mekanik yapay zekâ işlevleri, <code>+AI</code> kullanımını zorunlu olarak gerektirmez.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Örnek:</p>
            <pre><code>Yazar: Eric Mourant +AI</code></pre>
            <p>Bir projenin ayrıca şu beyanda bulunması İSTEĞE BAĞLIDIR:</p>
            <pre><code>Bu proje +AI kullanır.</code></pre>
    ...
    "notation": "+AI"
      ...
      },
      {
        ...
        body: `
            ...
            <p>Gösterimin yararı, evrensel bir uzlaşı olarak işleyebilme yeteneğine bağlıdır.</p>`
      },
      {
        number: "20",
        title: "Tarafsızlık",
      ...
      },
      {
        ...
        body: `
            ...
            <p>Bir yapıtın ağırlıklı olarak insan kaynaklı içerik barındırması ve buna karşın yine de kapsama girmesi İSTEĞE BAĞLIDIR.</p>
            <p>Bir yapıtın ağırlıklı olarak yapay zekâ kaynaklı içerik barındırması ve buna karşın yine de kapsama girmesi İSTEĞE BAĞLIDIR.</p>
