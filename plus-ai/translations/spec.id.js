    ...
    sections: [
      {
        ...
        title: "Tujuan",
        body: `
            <p>Notasi <code>+AI</code> menyediakan cara ringkas untuk menyatakan bahwa suatu artefak dibantu secara substansial oleh kecerdasan artifisial, sekaligus menyebutkan orang atau organisasi yang menerima tanggung jawab atas artefak yang dihasilkan.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Artefak masa kini dapat berpindah berulang kali antara manusia dan sistem kecerdasan artifisial selama proses penciptaannya.</p>
            <p>Sebaliknya, <code>+AI</code> menyampaikan dua fakta:</p>
            <ol>
              <li>kecerdasan artifisial membantu pekerjaan tersebut secara substansial; dan</li>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Kecerdasan artifisial membantu secara substansial dalam menciptakan, menganalisis, mentransformasi, menghasilkan, mengevaluasi, menyusun, atau menyajikan artefak yang terkait.</p>
            ...
            <p>Pihak bertanggung jawab telah mengizinkan, memulai, mengarahkan, atau dengan sadar mengadopsi penggunaan kecerdasan artifisial yang bersangkutan.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Dengan menggunakan tanda ini, pihak bertanggung jawab tidak mengalihkan tanggung jawab kepada sistem, model, penyedia, agen, atau perkakas kecerdasan artifisial.</p>
            ...
            <p>Pihak bertanggung jawab DAPAT menerbitkan isi yang sebagian besar dihasilkan oleh AI.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p><strong>Eric Mourant +AI</strong></p>
            <p>Hal ini berarti:</p>
            <blockquote>Kecerdasan artifisial membantu pekerjaan yang terkait secara substansial, dan Eric Mourant menerima tanggung jawab atas pelepasan pekerjaan tersebut.</blockquote>
            <p>Tanda ini berkaitan dengan artefak atau komunikasi yang terkait dengannya.</p>
            <p>Tanda ini tidak selalu berarti bahwa setiap kegiatan yang dilakukan oleh individu tersebut menggunakan kecerdasan artifisial.</p>`
      },
      {
        number: "11",
        title: "Organisasi",
  ...
  "ai_assistance": {
    ...
    "notation": "+AI"
      ...
      },
      {
        ...
        title: "Kenetralan",
        body: `
            <p><code>+AI</code> tidak menyatakan persetujuan maupun ketidaksetujuan terhadap kecerdasan artifisial.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <blockquote><strong><code>+AI</code> berarti kecerdasan artifisial membantu pekerjaan ini secara substansial dan orang atau organisasi yang disebutkan menerima tanggung jawab atas artefak yang dihasilkan.</strong></blockquote>`
      },
      {
        number: "24",
        title: "Uji +AI",
