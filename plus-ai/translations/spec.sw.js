  ...
  registry.register("sw", {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `
            <p>Maneno <strong>LAZIMA (MUST)</strong>, <strong>NI MARUFUKU (MUST NOT)</strong>, <strong>INAPASWA (SHOULD)</strong>, <strong>HAIPENDEKEZWI (SHOULD NOT)</strong>, na <strong>INAWEZA (MAY)</strong> ni masharti ya kikanuni katika fafanuzi hii.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Miundo mingine INAWEZA kufafanuliwa baadaye kwa nyongeza za fafanuzi hii, lakini NI MARUFUKU kudhania kwamba miundo hiyo ina maana ya kikanuni ya <code>+AI</code> isipokuwa imefafanuliwa waziwazi.</p>`
      },
      {
        number: "5",
      ...
      },
      {
        ...
        body: `
            ...
            <p>Utendaji wa akili bandia wa kubahatisha au wa kimekanika tu si lazima uhitaji <code>+AI</code>.</p>
      ...
      },
      {
        ...
        body: `
            <p>Isipokuwa tangazo la nyongeza linaeleza vinginevyo waziwazi, <code>+AI</code> HAITHIBITISHI kwamba:</p>
            <ul>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Matoleo yajayo ya fafanuzi hii INAWEZA kufafanua alama zenye uhakikisho mkubwa zaidi zinazowakilisha ukaguzi kamili au uthibitishaji wa kujitegemea.</p>`
      },
      {
        number: "10",
        title: "Watu binafsi",
      ...
      },
      {
        ...
        body: `
            ...
            <p>Mfano:</p>
            <pre><code>Mwandishi: Eric Mourant +AI</code></pre>
            <p>Mradi INAWEZA kutangaza zaidi:</p>
            <pre><code>Mradi huu unatumia +AI.</code></pre>
  ...
  "ai_assistance": {
    ...
    "notation": "+AI"
      ...
      },
      {
        ...
        title: "Udumu",
        body: `
            <p>Nukuu <code>+AI</code> INAPASWA kudumu katika mabadiliko ya kawaida ya bidhaa pale utambulisho wa mtoaji unahifadhiwa.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Fafanuzi zijazo INAWEZA kufafanua nukuu kwa matokeo ya akili bandia yanayojiendesha.</p>`
      },
      {
        number: "22",
    ...
    end: "<p>Fafanuzi ya +AI toleo la 0.1</p><p>Asili na Uwajibikaji kati ya Mwanadamu na Akili Bandia</p><strong>AI ilisaidia. Mimi ninachukua jukumu.</strong>"
  });
