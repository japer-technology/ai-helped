    ...
    sections: [
      ...
      },
      {
        ...
        body: `
            ...
            <ol>
              ...
              <li>특정 가능한 개인 또는 조직이 그 산출물에 대한 책임을 인수한다는 사실.</li>
            </ol>
      ...
      },
      {
        ...
        body: `
            ...
            <p><strong>감사합니다.<br>Eric Mourant +AI</strong></p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>예:</p>
            <pre><code>저자: Eric Mourant +AI</code></pre>
            <p>프로젝트는 추가로 다음과 같이 선언할 수 있다.</p>
            <pre><code>이 프로젝트는 +AI를 사용합니다.</code></pre>
      ...
      },
      {
        ...
        body: `
            ...
            <p><code>+AI</code>가 출판사, 규제기관, 사용자(고용주), 전문직 단체 또는 법률이 요구하는 더 구체적인 공개를 대체하는 것으로 표시해서는 안 된다.</p>
    ...
    "notation": "+AI"
      ...
      },
      {
        ...
        body: `
            ...
            <ul>
              <li>특정 가능한 책임 주체가 존재하지 않는 경우.</li>
      ...
      },
      {
        ...
        body: `
            ...
            <p class="canonical">특정 가능한 사람의 책임이 수반된 AI 지원 작업.</p>`
      },
      {
        number: "26",
        title: "정규 선언",
