...
(function (registry) {
  registry.register("vi", {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `
            <p>Các thuật ngữ <strong>PHẢI (MUST)</strong>, <strong>KHÔNG ĐƯỢC (MUST NOT)</strong>, <strong>NÊN (SHOULD)</strong>, <strong>KHÔNG NÊN (SHOULD NOT)</strong> và <strong>CÓ THỂ (MAY)</strong> là các yêu cầu quy phạm trong quy phạm kỹ thuật này.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Các biến thể CÓ THỂ được định nghĩa về sau bằng các phần mở rộng của quy phạm kỹ thuật này, nhưng KHÔNG ĐƯỢC mặc định rằng chúng mang ý nghĩa chuẩn tắc của <code>+AI</code> trừ khi được định nghĩa một cách minh thị.</p>`
      },
      {
        number: "5",
      ...
      },
      {
        ...
        body: `
            ...
            <p>Bên chịu trách nhiệm CÓ THỂ công bố nội dung được AI tạo ra về cơ bản.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Các phiên bản tương lai của quy phạm kỹ thuật này CÓ THỂ định nghĩa những dấu hiệu bảo đảm mạnh hơn, biểu thị việc soát xét toàn bộ hoặc việc kiểm chứng độc lập.</p>`
      },
      {
        number: "10",
        title: "Cá nhân",
  ...
  "ai_assistance": {
    ...
    "notation": "+AI"
      ...
      },
      {
        ...
        body: `
            ...
            <p>Các quy phạm kỹ thuật tương lai CÓ THỂ định nghĩa ký hiệu cho kết quả AI tự hành.</p>`
      },
      {
        number: "22",
    ...
    end: "<p>Quy phạm kỹ thuật +AI phiên bản 0.1</p><p>Nguồn gốc và trách nhiệm giải trình giữa con người và AI</p><strong>AI đã hỗ trợ. Tôi chịu trách nhiệm.</strong>"
  });
