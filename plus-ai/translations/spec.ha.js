    ...
    sections: [
      {
        ...
        title: "Manufa",
        body: `
            <p>Alamar <code>+AI</code> tana samar da hanya mai sauƙi don nuna cewa wani abu da aka samar ya sami taimako mai muhimmanci daga hankalin ɗan adam na wucin gadi, tare da nuna mutum ko ƙungiyar da ke ɗaukar alhakin abin da aka samar.</p>
            <p>Ainihin bayanin shi ne:</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Saboda haka ƙa'idar tana da alaƙa da <strong>shiga na hankalin wucin gadi da ɗaukar alhaki na ɗan adam</strong>, ba wai mallakar aikin kaɗai ba.</p>`
      },
      {
        number: "3",
      ...
      },
      {
        ...
        body: `
            ...
            <p>Mai ɗaukar alhaki ya riƙe ikon yanke shawara kan ko za a wallafa, aika, girka, gabatar ko fitar da abin da aka samar.</p>
            <h4>5.5 Karɓa</h4>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Aikin hankalin wucin gadi na ɗan lokaci ko na injina kaɗai ba lallai ne ya buƙaci <code>+AI</code> ba.</p>
      ...
      },
      {
        ...
        body: `
            ...
            <p>Mai ɗaukar alhaki ANA IYA wallafa abin da hankalin wucin gadi ya samar mafi yawa.</p>
